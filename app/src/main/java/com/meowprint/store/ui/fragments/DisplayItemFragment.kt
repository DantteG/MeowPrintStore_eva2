...
import com.meowprint.store.model.CartItem
import com.meowprint.store.session.CartManager
...
class DisplayItemFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Habilitar botón solo si hay stock
        binding.btnAddToCart.isEnabled = (productStock ?: 0) > 0
        ...
        binding.btnAddToCart.setOnClickListener {
            ...
            val item = CartItem(
                ...
                unitPrice = (productPrice ?: 0f).toDouble(),
                quantity = 1
            )
