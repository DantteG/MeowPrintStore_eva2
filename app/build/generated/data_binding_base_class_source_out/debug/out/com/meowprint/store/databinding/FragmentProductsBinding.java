...
public final class FragmentProductsBinding implements ViewBinding {
  ...
  private FragmentProductsBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView rvProducts,
  ...
  public static FragmentProductsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentProductsBinding((LinearLayout) rootView, rvProducts, searchView);
    }
